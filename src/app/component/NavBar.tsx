  ...
  return (
    <div>
        ...
        <div className="text-black inline-flex  bg-ryzen-950  w-full h-20 place-content-end rounded-3xl mt-5 mb-5">
          <a href="https://www.instagram.com/mizuu.edit/" className="w-full h- inline-flex items-center  pl-10 " >  <Image src={mizuImage} alt="Description of Mizu" className="object-cover h-20 w-12 rounded-3xl" /></a>
